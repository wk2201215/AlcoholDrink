...
//$update_stmt->execute(["test", 123,"test","test",1,1]);
        $update_stmt->execute([$_POST['product_name'], $_POST['price'],$_POST['image_pass'],$_POST['product_description'],$category_id1,$_POST['product_id']]);
//$update_stmt->execute([$_POST['product_name'],$_POST['price'],$_POST['image_pass'],$_POST['product_description'],$category_id1,$_POST['product_id']]);
        // $update_stmt->execute([$_POST['product_name'],$_POST['price'],$_POST['image_pass'],$_POST['product_description'],$category_id1,$_POST['product_id']]);
