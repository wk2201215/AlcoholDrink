...
<?php
    ...
    echo '<input type="text" name="postcode"  value="', $postcode, '" required>';
    echo '</td></tr>';
    echo '<tr><td>住所</td><td><br>';
    echo '<input type="text" name="address"  value="', $address, '" required>';
    echo '</td></tr>';
    echo '<tr><td>電話番号</td><td><br>';
    echo '<input type="text" name="tel"  value="', $tel, '" required>';
    echo '</td></tr>';
    echo '<tr><td>メールアドレス</td><td><br>';
    echo '<input type="text" name="mail"  value="', $mail, '" required>';
    echo '</td></tr>';
    echo '<tr><td>生年月日</td><td><br>';
    echo '<input type="date" name="dirth"  value="', $birth, '" required>';
    echo '</td></tr>';
