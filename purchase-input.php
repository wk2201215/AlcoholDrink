...
<?php
    ...
    echo '<p>配送料・手数料',$fee,'</p>';

    echo 'お届け先';
    
    echo $SESIION['cusotmer']['address'];
    ?>
    <button type="button" onclick="location.href='customer-input.php'">住所変更</button>
<?php
    echo '支払い方法';
    
    echo $SESIION['cusotmer']['payment'];
    ?>
    <button type="button" onclick="location.href='customer-payment-input.php'">支払い方法を変更</button>
